...
public class BookManagment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane4.setViewportView(jTabbedPane5);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        System.out.println(jScrollPane4.getLocationOnScreen());
        
        System.out.println(BookID.getLocationOnScreen());
        System.out.println(BookISBN.getLocationOnScreen());
        System.out.println(BookTitle.getLocationOnScreen());
        System.out.println(Author.getLocationOnScreen());
        System.out.println(Publisher.getLocationOnScreen());
        System.out.println(Edition.getLocationOnScreen());
        System.out.println(Category.getLocationOnScreen());
        System.out.println(Course.getLocationOnScreen());
        System.out.println(Department.getLocationOnScreen());
        System.out.println(Number_of_page.getLocationOnScreen());
        
        System.out.println(jButton2.getLocationOnScreen());
